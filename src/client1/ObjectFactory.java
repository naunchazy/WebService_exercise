...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server1/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server1/", "queryWeatherResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server1/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server1/", name = "queryWeatherResponse")
