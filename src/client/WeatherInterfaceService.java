 ...
 * 2018-01-30T17:43:53.254+08:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", 
                  wsdlLocation = "http://localhost:8088/weather?wsdl",
...
public class WeatherInterfaceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8088/weather?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherInterfaceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8088/weather?wsdl");
        }
        WSDL_LOCATION = url;
    }
