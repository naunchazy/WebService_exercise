...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server2/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server2/", "queryWeatherResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server2/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server2/", name = "queryWeatherResponse")
