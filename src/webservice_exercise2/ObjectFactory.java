 ...
 * generated in the webservice_exercise2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://webservice_exercise/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://webservice_exercise/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: webservice_exercise2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice_exercise/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice_exercise/", name = "queryWeatherResponse")
