 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceImplService", targetNamespace = "http://webservice_exercise/", wsdlLocation = "http://127.0.0.1:8088/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACEIMPLSERVICE_QNAME = new QName("http://webservice_exercise/", "WeatherInterfaceImplService");
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort() {
        return super.getPort(new QName("http://webservice_exercise/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class);
    }
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice_exercise/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class, features);
    }
